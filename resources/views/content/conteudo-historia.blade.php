    ...
    <div class="col-md-11 mx-auto">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h2 class="h4 text-center dru-text-color-title">Página 2: Uma Viagem pela História – Dos Primeiros Rabiscos Digitais à Realidade Virtual</h2>
            </div>
